    ...
    switch (parentId) {
      ...
      default:
        url =
          {
            // containers
            app1: "http://localhost:9002/app1.container.bundle",
...
export function Root() {
  return (
    <NavigationContainer>
      <Tab.Navigator initialRouteName="App2">
        <Tab.Screen name="App1Tab" component={HomeStack} />
        <Tab.Screen name="App2Tab" component={App2Wrapper} />
      </Tab.Navigator>
    </NavigationContainer>
  );
}
